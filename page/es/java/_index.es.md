 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Edite, guarde y renderice elementos de esquema XPS
    </p>
   </div>
   <div class="col-lg-4">
...
<h2 class="h2title">Easily Manipulate XPS Paginas</h2>

<p>Aspose.XPS for Java provides extensive support for page manipulation. You can add a page to the end of the page list or insert it at any specified position. API XPS de Java also allows to remove pages, select a page by number as “active” or create a page without binding it to the document.</p>
...
{{< blocks/products/pf/slr-element name="Referencias de API" href="https://reference.aspose.com/page/java/" >}}
