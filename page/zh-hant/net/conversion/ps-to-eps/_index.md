...
title: 用於 C# 的 PS 到 EPS 轉換 API | .NET
url: /net/conversion/ps-to-eps/
description: PS 到 EPS C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 PS 文件批量轉換為 EPS。
informat: PS
outformat: EPS
...
---
h1: PS轉EPS
h2: 通過 .NET 的 API 解決方案將 PS 轉換為 EPS。
---

{{<section overview>}}
---
title: "如何使用 C# 將 PS 轉換為 EPS"
p1: "用於 PS 到 EPS 轉換器的 Aspose.Page 提供使用 .NET 平台支持的任何語言將封裝 PostScript (PS) 文件轉換為 EPS 文件：C#、VB、J#。"
...
{{<section feature1>}}
---
title: "通過 C# 將 PS 轉換為 EPS 的步驟"
h3: "此示例代碼顯示 PS 到 EPS C# 轉換"
