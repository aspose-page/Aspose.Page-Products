 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Pustaka menyediakan kelas khusus untuk mengonversi file EPS dan PS ke gambar raster dan PDF. Konfigurasi proses konversi mudah untuk mengontrol kualitas gambar dalam PDF serta untuk gambar yang berdiri sendiri. Selain itu, pengembang dapat dengan mudah menekan kesalahan jika mereka bekerja dengan batch.
    </p>
   </div>
   <!--
...
<h2 class="h2title">Easily Manipulate XPS halaman</h2>

<p>Aspose.XPS for Java provides extensive support for page manipulation. You can add a page to the end of the page list or insert it at any specified position. API Java XPS also allows to remove pages, select a page by number as “active” or create a page without binding it to the document.</p>
