...
{{< blocks/products/pf/upper-banner h1="Convert PS to WMF via C#" h2="Render PS as WMF on .NET Framework Platform, Windows and ASP.NET Applications." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/page/aspose_page-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WMF" pfName="Aspose.Page" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PS" >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PS to WMF C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "4bea593fe35730d0d7831b00b656f9fc" "convert-ps-to-wmf.cs" >}}
