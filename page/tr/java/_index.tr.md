...
<h2 class="h2title">Easily Manipulate XPS Sayfalar</h2>

<p>Aspose.XPS for Java provides extensive support for page manipulation. You can add a page to the end of the page list or insert it at any specified position. Java XPS API'si also allows to remove pages, select a page by number as “active” or create a page without binding it to the document.</p>
...
{{< blocks/products/pf/slr-element name="API Referansları" href="https://apireference.aspose.com/java/page" >}}
