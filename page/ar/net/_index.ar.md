 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     إنشاء والتعامل مع أشكال الرسومات المتجهة وسلاسل النص
    </p>
   </div>
   <div class="col-lg-4">
...
<p>Aspose.Page لـ .NET provides extensive support for page manipulation. You can add a page to the end of the page list or insert it at any specified position. .NET الصفحات API also allows to remove pages, select a page by number as “active” or create a page without binding it to the document.</p>
