 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Biblioteka udostępnia specjalistyczne klasy do konwersji plików EPS i PS na obrazy rastrowe i PDF. Konfiguracja procesu konwersji jest łatwa do kontrolowania jakości obrazu w pliku PDF, a także w przypadku obrazów samodzielnych. Ponadto programiści mogą łatwo pomijać błędy, jeśli pracują z partiami.
    </p>
   </div>
   <!--
...
<h2 class="h2title">Easily Manipulate XPS Strony</h2>

<p>Aspose.XPS for Java provides extensive support for page manipulation. You can add a page to the end of the page list or insert it at any specified position. Interfejs API Java XPS also allows to remove pages, select a page by number as “active” or create a page without binding it to the document.</p>
