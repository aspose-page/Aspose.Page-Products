...
<div class="diagram1 d2 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <!--<header><i class="fa fa-long-arrow-down "> </i> Entrée uniquement</header>
  ...
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     <h3>
      Ajouter des pages de document au fichier XPS - C++
     </h3>
...
{{< blocks/products/pf/slr-element name="Références API" href="https://reference.aspose.com/page/cpp" >}}
