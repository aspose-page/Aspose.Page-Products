...
title: एक्सपीएस से पीडीएफ रूपांतरण एपीआई | Java
url: /java/conversion/xps-to-pdf/
description: एक्सपीएस प्रारूप के लिए पीडीएफ फाइल के लिए नमूना Java रूपांतरण कोड। किसी भी वेब या डेस्कटॉप Java आधारित एप्लिकेशन में एक्सपीएस को पीडीएफ में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
informat: XPS
outformat: PDF
otherformats: EPS PS
---
...
h2: Java के लिए एपीआई समाधान के माध्यम से एक्सपीएस को पीडीएफ में बदलें।
---

{{<section overview>}}
---
title: "Java का उपयोग करके एक्सपीएस को पीडीएफ में कैसे बदलें"
p1: "Aspose.Page for XPS to PDF कनवर्टर Java द्वारा समर्थित किसी भी भाषा के उपयोग के साथ XPS फ़ाइल को PDF छवि में बदलने की पेशकश करता है"
...
{{<section feature1>}}
---
title: "Java के माध्यम से एक्सपीएस को पीडीएफ में बदलने के चरण"
h3: "यह नमूना कोड XPS से PDF Java रूपांतरण दिखाता है"
...
p2: "एक्सपीएस से पीडीएफ Java रूपांतरण"
---
