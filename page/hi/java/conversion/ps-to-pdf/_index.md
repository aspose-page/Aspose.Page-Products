...
title: पीएस टू पीडीएफ रूपांतरण एपीआई | Java
url: /java/conversion/ps-to-pdf/
description: पीएस प्रारूप के लिए पीडीएफ फाइल के लिए नमूना Java रूपांतरण कोड। किसी भी वेब या डेस्कटॉप Java आधारित एप्लिकेशन में PS को PDF में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
informat: PS
outformat: PDF
...
---
h1: पीएस से पीडीएफ
h2: Java के लिए एपीआई समाधान के माध्यम से पीएस को पीडीएफ में बदलें।
---

{{<section overview>}}
---
title: "Java का उपयोग करके पीएस को पीडीएफ में कैसे बदलें"
p1: "Aspose.Page for PS to PDF कनवर्टर Java द्वारा समर्थित किसी भी भाषा के उपयोग के साथ पीएस फ़ाइल को पीडीएफ छवि में रूपांतरण प्रदान करता है"
...
{{<section feature1>}}
---
title: "Java के माध्यम से पीएस को पीडीएफ में बदलने के चरण"
h3: "यह नमूना कोड पीएस से पीडीएफ Java रूपांतरण दिखाता है"
...
p2: "पीएस टू पीडीएफ Java रूपांतरण"
---
