...
title: 用于 C# 的 PS 到 PNG 转换 API | .NET
url: /net/conversion/ps-to-png/
description: PS 到 PNG C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 PS 文件批量转换为 PNG。
informat: PS
outformat: PNG
...
---
h1: PS转PNG
h2: 通过 .NET 的 API 解决方案将 PS 转换为 PNG。
---

{{<section overview>}}
---
title: "如何使用 C# 将 PS 转换为 PNG"
p1: "用于 PS 到 PNG 转换器的 Aspose.Page 使用 .NET 平台支持的任何语言提供封装 PostScript (PS) 文件到 PNG 图像的转换：C#、VB、J#。"
...
{{<section feature1>}}
---
title: "通过 C# 将 PS 转换为 PNG 的步骤"
h3: "此示例代码显示 PS 到 PNG C# 转换"
