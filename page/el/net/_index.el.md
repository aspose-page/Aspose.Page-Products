 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Δημιουργήστε και χειριστείτε σχήματα διανυσματικών γραφικών και συμβολοσειρές κειμένου
    </p>
   </div>
   <div class="col-lg-4">
...
<p>Aspose.Page για .NET provides extensive support for page manipulation. You can add a page to the end of the page list or insert it at any specified position. .NET Σελίδες API also allows to remove pages, select a page by number as “active” or create a page without binding it to the document.</p>
