...
title: API μετατροπής XPS σε TIFF για C# |  .NET
url: /net/conversion/xps-to-tiff/
description: Δείγμα κώδικα για μετατροπή XPS σε TIFF C#. Χρησιμοποιήστε παράδειγμα κώδικα API για ομαδική μετατροπή αρχείων XPS σε TIFF εντός VB.NET, Asp.NET ή οποιασδήποτε εφαρμογής που βασίζεται σε .NET.
informat: XPS
outformat: TIFF
...
---
h1: XPS σε TIFF
h2: Μετατροπή XPS σε TIFF μέσω λύσης API για .NET.
---

{{<section overview>}}
---
title: "Πώς να μετατρέψετε XPS σε TIFF χρησιμοποιώντας C#"
p1: "Ο μετατροπέας Aspose.Page για XPS σε TIFF προσφέρει μετατροπή του αρχείου Encapsulated PostScript (PS) σε εικόνα TIFF με χρήση οποιασδήποτε γλώσσας που υποστηρίζεται από την πλατφόρμα .NET: C#, VB, J#."
...
{{<section feature1>}}
---
title: "Βήματα για τη μετατροπή XPS σε TIFF μέσω C#"
h3: "Αυτό το δείγμα κώδικα δείχνει τη μετατροπή XPS σε TIFF C#"
