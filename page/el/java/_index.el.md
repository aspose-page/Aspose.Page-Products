 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Επεξεργαστείτε, αποθηκεύστε και αποδώστε στοιχεία περίληψης XPS
    </p>
   </div>
   <div class="col-lg-4">
...
<h2 class="h2title">Easily Manipulate XPS Σελίδες</h2>
...
{{< blocks/products/pf/slr-element name="Αναφορές API" href="https://reference.aspose.com/page/java/" >}}
