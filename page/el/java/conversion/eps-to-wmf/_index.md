...
title: API μετατροπής EPS σε WMF για | Java
url: /java/conversion/eps-to-wmf/
description: Δείγμα κώδικα μετατροπής Java για μορφή EPS σε αρχείο WMF. Χρησιμοποιήστε αυτό το παράδειγμα κώδικα για να μετατρέψετε το EPS σε WMF σε οποιαδήποτε εφαρμογή που βασίζεται σε Web ή Desktop Java.
informat: EPS
outformat: WMF
otherformats: XPS PS
---
...
---
h1: EPS σε WMF
h2: Μετατροπή EPS σε WMF μέσω Λύσης API για Java.
---

{{<section overview>}}
---
title: "Πώς να μετατρέψετε το EPS σε WMF χρησιμοποιώντας Java"
p1: "Το Aspose.Page για μετατροπέα EPS σε WMF προσφέρει μετατροπή του αρχείου Encapsulated PostScript (EPS) σε εικόνα WMF με χρήση οποιασδήποτε γλώσσας που υποστηρίζεται από Java"
...
{{<section feature1>}}
---
title: "Βήματα για τη μετατροπή EPS σε WMF μέσω Java"
h3: "Αυτό το δείγμα κώδικα δείχνει τη μετατροπή EPS σε WMF Java"
