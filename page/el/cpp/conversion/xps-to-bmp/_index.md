...
title: API μετατροπής XPS σε BMP | C++
url: /cpp/conversion/xps-to-bmp/
description: Η μετατροπή XPS σε BMP παρέχεται από το Aspose.Page για λύση API C++. Λειτουργεί σε C++ Runtime Environment για Windows 32 bit, Windows 64 bit και Linux 64 bit.
informat: XPS
outformat: BMP
otherformats: EPS PS
---
...
---
h1: XPS σε BMP
h2: Μετατροπή XPS σε BMP μέσω Λύσης API για C++.
---

{{<section overview>}}
---
title: "Πώς να μετατρέψετε XPS σε BMP χρησιμοποιώντας C++"
p1: "Ο μετατροπέας Aspose.Page για XPS σε BMP προσφέρει μετατροπή σε εικόνα BMP με χρήση οποιασδήποτε γλώσσας που υποστηρίζεται από τη C++."
...
{{<section feature1>}}
---
title: "Βήματα για τη μετατροπή XPS σε BMP χρησιμοποιώντας C++"
h3: "Αυτό το δείγμα κώδικα εξηγεί τη μετατροπή XPS σε BMP C++"
