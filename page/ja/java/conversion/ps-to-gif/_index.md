...
description: PS 形式から GIF ファイルへの Java 変換コードのサンプル。このコード例を使用して、Web またはデスクトップ Java ベースのアプリケーション内で PS を GIF に変換します。
informat: PS
outformat: GIF
...
---
h1: PSからGIFへ
h2: Java 用 API ソリューションを介して PS を GIF に変換します。
---

{{<section overview>}}
---
title: "Java を使用して PS を GIF に変換する方法"
p1: "PS から GIF へのコンバーター用の Aspose.Page は、Java がサポートする任意の言語を使用して、PS ファイルから BMP イメージへの変換を提供します。"
...
{{<section feature1>}}
---
title: "Java 経由で PS を GIF に変換する手順"
h3: "このサンプル コードは、PS から GIF への Java 変換を示しています。"
