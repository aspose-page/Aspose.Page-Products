...
title: 에 대한 EPS에서 PS로의 변환 API | Java
url: /java/conversion/eps-to-ps/
description: EPS 형식을 PS 파일로 변환하는 샘플 Java 변환 코드. 이 예제 코드를 사용하여 웹 또는 데스크탑 Java 기반 응용 프로그램 내에서 EPS를 PS로 변환합니다.
informat: EPS
outformat: PS
otherformats: XPS PS
---
...
---
h1: EPS에서 PS로
h2: Java용 API 솔루션을 통해 EPS를 PS로 변환합니다.
---

{{<section overview>}}
---
title: "Java를 사용하여 EPS를 PS로 변환하는 방법"
p1: "Aspose.Page for EPS to PS 변환기는 Java에서 지원하는 모든 언어를 사용하여 EPS(Encapsulated PostScript) 파일을 PS 이미지로 변환합니다."
p2: "여기에서 볼 수 있는 API를 사용하여 자체 플랫폼 간 애플리케이션을 만들거나 Java 프로젝트에 통합할 수 있습니다."
p3: "XPS를 PS로 변환하려면 다음을 사용합니다."
...
{{<section feature1>}}
---
title: "Java를 통해 EPS를 PS로 변환하는 단계"
h3: "이 샘플 코드는 EPS에서 PS Java로의 변환을 보여줍니다."
