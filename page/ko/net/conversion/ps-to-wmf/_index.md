...
title: C#용 PS에서 WMF로의 변환 API |  .NET
url: /net/conversion/ps-to-wmf/
description: PS에서 WMF C#으로의 변환을 위한 샘플 코드입니다. VB.NET, Asp.NET 또는 모든 .NET 기반 응용 프로그램 내에서 배치 PS 파일을 WMF로 변환하는 API 예제 코드를 사용합니다.
informat: PS
outformat: WMF
...
---
h1: PS에서 WMF로
h2: .NET용 API 솔루션을 통해 PS를 WMF로 변환합니다.
---

{{<section overview>}}
---
title: "C#을 사용하여 PS를 WMF로 변환하는 방법"
p1: "Aspose.Page for PS to WMF 변환기는 .NET 플랫폼에서 지원하는 모든 언어(C#, VB, J#)를 사용하여 PS(Encapsulated PostScript) 파일을 WMF 이미지로 변환합니다."
...
{{<section feature1>}}
---
title: "C#을 통해 PS를 WMF로 변환하는 단계"
h3: "이 샘플 코드는 PS에서 WMF C#으로의 변환을 보여줍니다."
