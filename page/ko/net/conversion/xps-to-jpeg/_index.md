...
title: C#용 XPS에서 JPEG로의 변환 API |  .NET
url: /net/conversion/xps-to-jpeg/
description: XPS에서 JPEG C#으로 변환하기 위한 샘플 코드입니다. VB.NET, Asp.NET 또는 모든 .NET 기반 응용 프로그램 내에서 배치 XPS 파일을 JPEG로 변환하는 API 예제 코드를 사용합니다.
informat: XPS
outformat: JPEG
...
---
h1: XPS에서 JPEG로
h2: .NET용 API 솔루션을 통해 XPS를 JPEG로 변환합니다.
---

{{<section overview>}}
---
title: "C#을 사용하여 XPS를 JPEG로 변환하는 방법"
p1: "XPS to JPEG 변환기용 Aspose.Page는 .NET 플랫폼에서 지원하는 모든 언어(C#, VB, J#)를 사용하여 PS(Encapsulated PostScript) 파일을 JPEG 이미지로 변환하는 기능을 제공합니다."
...
{{<section feature1>}}
---
title: "C#을 통해 XPS를 JPEG로 변환하는 단계"
h3: "이 샘플 코드는 XPS에서 JPEG C#으로의 변환을 보여줍니다."
