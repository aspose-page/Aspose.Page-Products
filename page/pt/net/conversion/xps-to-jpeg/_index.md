...
title: API de conversão de XPS para JPEG para C# |  .NET
url: /net/conversion/xps-to-jpeg/
description: Código de exemplo para conversão de XPS para JPEG C#. Use o código de exemplo da API para arquivos XPS em lote para conversão JPEG em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
informat: XPS
outformat: JPEG
...
---
h1: XPS para JPEG
h2: Converta XPS para JPEG via Solução API para .NET.
---

{{<section overview>}}
---
title: "Como converter XPS para JPEG usando C#"
p1: "Aspose.Page for XPS para conversor JPEG oferece conversão de arquivo Encapsulated PostScript (PS) para imagem JPEG com o uso de qualquer linguagem suportada pela plataforma .NET: C#, VB, J#."
...
{{<section feature1>}}
---
title: "Passos para converter XPS para JPEG via C#"
h3: "Este código de exemplo mostra a conversão de XPS para JPEG C#"
