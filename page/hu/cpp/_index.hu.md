...
<div class="diagram1 d2 d1-cplus">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <!--<header><i class="fa fa-long-arrow-down "> </i> Csak bevitel</header>

<ul>

<li><b>Utóirat: </b> EPS, PS</li>
...
<h2 class="h2title">Easily Manipulate Oldalak</h2>

<p>Aspose.Page for .NET provides extensive support for page manipulation. You can add a page to the end of the page list or insert it at any specified position. .NET Oldalak API also allows to remove pages, select a page by number as “active” or create a page without binding it to the document.</p>
