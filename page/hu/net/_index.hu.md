 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Hozzon létre és kezeljen vektorgrafikus alakzatokat és szöveges karakterláncokat
    </p>
   </div>
   <div class="col-lg-4">
...
<p>Aspose.Page .NET-hez provides extensive support for page manipulation. You can add a page to the end of the page list or insert it at any specified position. .NET Oldalak API also allows to remove pages, select a page by number as “active” or create a page without binding it to the document.</p>
